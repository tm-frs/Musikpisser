...
module.exports = {
	...
	opt: {
		...
		adminperms: [`USERNAME#XXXX`] // write the Username of the user(s) that is/are allowed to use admin commands (excluded from rrm-mode, get this bot's ip with a discord-command, crash the bot with the crash command); new usernames are '[username]#0' instead of '[username]#[discriminator]'
	}
};
