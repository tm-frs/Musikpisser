...
var ValidationError = class extends BaseError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const given = inspect2(this.given, newOptions).replaceAll("\n", padding);
...
var ExpectedValidationError = class extends ValidationError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const expected = inspect3(this.expected, newOptions).replaceAll("\n", padding);
    const given = inspect3(this.given, newOptions).replaceAll("\n", padding);
...
var UnknownPropertyError = class extends BaseError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${options.stylize("|", "undefined")} `;
    const given = inspect4(this.value, newOptions).replaceAll("\n", padding);
...
import { inspect as inspect5 } from "node:util";
var MultiplePossibilitiesConstraintError = class extends BaseConstraintError {
  ...
  [customInspectSymbolStackLess](depth, options) {
    ...
    const padding = `
  ${verticalLine} `;
    const given = inspect5(this.given, newOptions).replaceAll("\n", padding);
