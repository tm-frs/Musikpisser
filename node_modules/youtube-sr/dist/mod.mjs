import{createRequire as cr1650605729687}from"module";var require=cr1650605729687(import.meta.url);var __defProp = Object.defineProperty;
...
var Util = class {
  ...
  static getVideo(html) {
    ...
    const raw = {
      primary: (_a = data.find((section) => "videoPrimaryInfoRenderer" in section)) == null ? void 0 : _a.videoPrimaryInfoRenderer,
      secondary: (_b = data.find((section) => "videoSecondaryInfoRenderer" in section)) == null ? void 0 : _b.videoSecondaryInfoRenderer
    };
    let info;
    try {
    ...
    const payload = new Video_default({
      ...
      duration: parseInt(info.info.lengthSeconds) * 1e3,
      duration_raw: Util.durationString(Util.parseMS(parseInt(info.info.lengthSeconds) * 1e3 || 0)),
      channel: {
        ...
        subscribers: (_d = (_c = info.owner.videoOwnerRenderer.subscriberCountText) == null ? void 0 : _c.simpleText) == null ? void 0 : _d.replace(" subscribers", "")
      },
      description: info.info.shortDescription,
      thumbnail: __spreadProps(__spreadValues({}, info.info.thumbnail.thumbnails[info.info.thumbnail.thumbnails.length - 1]), {
        id: info.info.videoId
      }),
    ...
    for (const result of body) {
      ...
      if (details) {
        try {
          ...
          results.push(new Video_default({
            id: details.videoId,
...
var YouTube = class {
  ...
  static trending() {
    return __async(this, null, function* () {
      var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m;
      const html = yield Util_default.getHTML("https://www.youtube.com/feed/explore?hl=en");
      let json;
      try {
