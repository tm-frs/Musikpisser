...
module.exports = {
	...
	run: async (client, interaction) => {
		...
		if (!queue.tracks.data[0] && !(queue.repeatMode === 2 || queue.repeatMode === 3)) return interaction.reply({ content: `No music in queue after current so this would stop the music ❌`, ephemeral: true }).catch((e) => { }); // eslint-disable-line no-unused-vars
